...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('bulk_airtime_sales_record', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('bulk_airtime_stock_record', function (Blueprint $table) {
            $table->id();
            $table->date('transaction_date')->required()->comment('Date of the transaction');
            $table->text('description')->required()->comment('Description of the transaction');
    ...
    {
        Schema::dropIfExists('bulk_airtime_sales_record');
        Schema::dropIfExists('bulk_airtime_stock_record');
    }
};
