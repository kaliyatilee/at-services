                ...
                <div class="col-12">
                    <div class="card my-4">
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route("client_add") }}"><i
                                ...
                                <table class="table align-items-center mb-0" id="dt-nested-object">
                                    ...
                                    @foreach($clients as $client)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <p class="mb-0 text-sm">{{ $client->phone1 }}</p>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <p class="mb-0 text-sm">{{ $client->phone2 }}</p>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <p class="mb-0 text-sm">{{ $client->created_at }}</p>
                                                </div>
                                            </td>
                                            <td class="align-middle">
												...
												href="{{ route("api_client_view", ['id' => $client->id]) }}"
												   data-original-title=""
                                                   title="">
