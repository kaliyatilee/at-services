<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar activePage="client_add_credit_authorized"></x-navbars.sidebar>
        ...
        <div class="container-fluid px-2 px-md-4">
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
					...
					<form id="edit_client_form" method='POST' action='{{ route('api_credit_authorized_client_update', ['id_number' => $client->id_number]) }}'>
                        @csrf
                        <div class="row">
...
`
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ $client->proof_of_residence }}"
                                    />
                                <div id="phone_success_error_message" class="text-danger text-xs"></div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label">Notes</label>
                                <textarea  class="form-control border border-2 p-2" name="notes" value="{{ $client->notes }}" id="" cols="30" rows="10"></textarea>
