<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Dry Cleaning > Sales Book"></x-navbars.navs.auth>
        <!-- End Navbar -->
                ...
                <div class="col-12">
                    <div class="card my-4">
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route("api_sales_book_create") }}"><i
                                ...
                                <table class="table align-items-center mb-0" id="dt-nested-object">
                                    ...
                                    @foreach($salesBooks as $sales)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <p class="mb-0 text-sm">{{ DB::table('dry_cleaning_services_providers')->find($sales->provider)->provider }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <p class="mb-0 text-sm">{{ $sales->expense_name }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                                    <p class="mb-0 text-sm">{{ $sales->expense_amount }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <td class="align-middle">
												...
												href="{{ route("api_sales_book_edit", $sales->id) }}" data-original-title=""
                                                   title="">
                                                    <i class="material-icons">edit</i>
                                                    <div class="ripple-container"></div>
                                                </a>

                                                <form action="{{ route('api_sales_book_delete', $sales->id) }}" method="post" style="display:inline">
                                                    @method('DELETE')
                                                    @csrf
