            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        ...
                        <form id="add_agent_transaction_form" method='POST'
                              action="{{ route('api_create_agent_transaction')}}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Amount Remmited</label>
                                    <input type="number" name="amount_remmited" class="form-control border border-2 p-2"
                                           value="{{ old('amount_remmited') }}">
                                </div>
