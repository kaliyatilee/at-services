<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="agents_transactions"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit Agent Transaction"></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        <form id="edit_agent_transaction_form" method='POST'
                              action="{{ route('api_update_agent_transaction',['id' => $transaction->id])}}">
                            @csrf
                            <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#edit_agent_transaction_form').submit(function (e) {
