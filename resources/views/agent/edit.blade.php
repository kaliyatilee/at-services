<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit Agent"></x-navbars.navs.auth>
        <!-- End Navbar -->
                ...
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        <form id="edit_agent_form" method='POST'
                              action='{{ route('api_update_agent', ['id' => $agent->id]) }}'>
                            @csrf
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Currency Name e.g. USD</label>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="payment_type" class="form-control border border-2 p-2"
                                           value='{{ $agent->payment_type }}'>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label"> Rate</label>
                                    <input type="text" id="rate" name="rate" class="form-control border border-2 p-2"
                                           value='{{ $agent->rate }}'>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Sales</label>
                                    <input type="text" name="sales" class="form-control border border-2 p-2"
                                           value='{{ $agent->sales }}'>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Amount to be Remitted</label>
                                    <input type="text" name="amount_to_be_remitted"
                                           class="form-control border border-2 p-2"
                                           value='{{ $agent->amount_to_be_remitted }}'>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Transaction Date</label>
                                    <input type="date" name="transaction_date" class="form-control border border-2 p-2"
                                           value='{{ $agent->transaction_date }}'>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Account Balance</label>
                                    <input type="text" name="account_balance" class="form-control border border-2 p-2"
                                           value='{{ $agent->account_balance }}'>
                                </div>
