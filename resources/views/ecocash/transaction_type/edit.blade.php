<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar activePage="ecocash_transaction_type_add"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit Ecocash Transaction Type"></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        <form id="edit_ecocash_transaction_type_form" method='POST' action='{{ route("api_update_ecocash_transaction_type", $ecocash_transaction_type->id) }}'>
                            @csrf
                            <div class="row">

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Type Name e.g. Cash In</label>
                                    <input type="text" name="name" class="form-control border border-2 p-2"
                                           value='{{ $ecocash_transaction_type->name }}'>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#edit_ecocash_transaction_type_form').submit(function (e) {
