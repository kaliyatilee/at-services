<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit  ZIG Transaction"></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        ...
                        <form id="edit_rtgs_form" method='POST' action='{{ route('api_update_rtgs', $rtgs->id) }}'>
                            @csrf
                            <div class="row">
							...
							<div class="mb-3 col-md-6">
								...
								<div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="description" class="form-control border border-2 p-2"
                                           value='{{ $rtgs->description }}'>
                                </div>
								<div class="mb-3 col-md-6">
									<label class="form-label">Transaction Date</label>
									<input type="date" name="transaction_date" class="form-control border border-2 p-2"
									value='{{ isset($rtgs->transaction_date) ? \Carbon\Carbon::parse($rtgs->transaction_date)->format("Y-m-d") : "" }}'>
								</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#edit_rtgs_form').submit(function (e) {
