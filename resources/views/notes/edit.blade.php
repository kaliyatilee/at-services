<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Edit Notes"></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        <form id="edit_notes_form" method='POST' action='{{ route('api_update_notes', ['id' => $notes->id]) }}'>
                            @csrf
                            <div class="row">

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Notes Date</label>
                                ...
                                <div class="mb-3 col-md-12">
                                    <label class="form-label">Notes</label>
                                           <textarea type="text" name="notes" class="form-control border border-2 p-2">{{ $notes->notes }}</textarea>
                                </div>
