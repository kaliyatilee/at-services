                ...
                <div class="col-12">
                    <div class="card my-4">
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route("expenses.create") }}">
                                <i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Expenses</a>
                        </div>
                                    ...
                                    @foreach($transaction as $transaction)
                                        <tr>
                                            ...
                                            <td class="align-middle">
												...
												href="{{ route("expenses.edit", $transaction->id) }}" data-original-title=""
                                                   title="">
                                                ...
                                                <a rel="tooltip" class="btn btn-primary btn-link"
													href="{{ route("expenses.view", $transaction->id) }}" data-original-title=""
                                                   title="">
