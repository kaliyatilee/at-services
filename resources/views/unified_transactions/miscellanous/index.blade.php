<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-navbars.sidebar activePage="miscellanous"></x-navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Miscellanous"></x-navbars.navs.auth>
        <!-- End Navbar -->
                ...
                <div class="col-12">
                    <div class="card my-4">
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route("miscellanous.create") }}"><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Miscellanous</a>
                        </div>
                                    ...
                                    @foreach($transaction as $transaction)
                                        <tr>
                                            ...
                                            <td class="align-middle">
												...
												href="{{ route("miscellanous.edit", $transaction->id) }}" data-original-title=""
                                                   title="">
                                                    <i class="material-icons">edit</i>
                                                    <div class="ripple-container"></div>
                                                </a>
                                                <a rel="tooltip" class="btn btn-primary btn-link"
													href="{{ route("miscellanous.view", $transaction->id) }}" data-original-title=""
                                                   title="">
                                                    <i class="material-icons">view_module</i>
                                                    <div class="ripple-container"></div>
                                                </a>

                                                <form action="{{ route('miscellanous.destroy', $transaction->id) }}" method="post" style="display:inline">
                                                    @method('DELETE')
                                                    @csrf
