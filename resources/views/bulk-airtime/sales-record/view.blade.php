                    ...
                    <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select diasbled class="form-control border border-2 p-2" name="currency" data-parsley-trigger="focusout" required data-parsley-required-message="Currency is required">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select disabled class="form-control border border-2 p-2" name="payment_type" data-parsley-trigger="focusout" required data-parsley-required-message="Payment type is required">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input readonly type="number" step=".01" name="percentage" max="100" min="0" class="form-control border border-2 p-2" data-parsley-trigger="focusout" required data-parsley-required-message="Commission percentage is required"
