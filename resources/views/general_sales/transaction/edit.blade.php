            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        <form method='POST' action='{{ route('update-general-sale') }}'>
                            @csrf
                            <input name="sale" class="form-control border border-2 p-2" value='{{ $transaction->id }}' required readonly hidden>
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control border border-2 p-2" value='{{ $transaction->name }}' placeholder="{{ $transaction->name }}">
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Phone Number</label>
                                    <input type="text" name="phone" class="form-control border border-2 p-2" value='{{ $transaction->phone }}' placeholder="{{ $transaction->phone }}">
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Amount</label>
                                    <input type="number" name="amount" class="form-control border border-2 p-2" value='{{ $transaction->amount }}' placeholder="{{ $transaction->amount }}">
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="notes" class="form-control border border-2 p-2" value='{{ $transaction->notes }}' placeholder="{{ $transaction->notes }}">
                                </div>

{{--                                <div class="mb-3 col-md-6">--}}
{{--                                    <label class="form-label">Classification</label>--}}
{{--                                    <select class="form-control border border-2 p-2" name="classification">--}}
