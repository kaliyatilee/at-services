            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="card card-plain h-100">
                    <div class="card-body p-3">
                        <form id="edit_client_form" method='POST' action='{{ route('api_create_user') }}'>
                            @csrf
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Is User Admin</label>
                                    <select class="form-control border border-2 p-2" name="is_admin">
