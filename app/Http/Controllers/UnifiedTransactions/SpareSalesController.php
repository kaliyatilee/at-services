...
class SpareSalesController extends Controller
{
    private $modelReference;

    public function __construct()
    {
        $this->modelReference = 3;
    }
    ...
    public function create()
    {
        try {
            ...
            return view('unified_transactions.spare_sales_book.create', compact('currencies'));
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading page.');
        }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('unified_transactions.spare_sales_book.edit', compact('transaction','currencies'));
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading page.');
        }
    ...
    public function view($id)
    {
        try {
            ...
            return view('unified_transactions.spare_sales_book.view',  compact('transaction','currencies'));
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading page.');
        }
