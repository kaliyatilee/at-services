...
class ExpensesController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return view('unified_transactions.expenses.create', compact('currencies'));
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading page.');
        }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('unified_transactions.expenses.edit', compact('transaction','currencies'));
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading page.');
        }
    ...
    public function view($id)
    {
        try {
            ...
            return view('unified_transactions.expenses.view',  compact('transaction','currencies'));
        } catch (\Exception $e) {
            Log::error($e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading page.');
        }
