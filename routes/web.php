...
Route::get(
	"company/registration/supplier/add",[CompanyRegistrationSupplierController::class, "add"]
...
Route::get(	'agent',[AgentController::class,'view'])->name( 'agent' );
Route::get(	'agent/add',[	AgentController::class,'add'])->name( 'agent_add' );
Route::get('agent/edit/{id}',[ AgentController::class,'agent_edit'])->name( 'agent_edit' );
Route::delete('agent/delete/{id}',	[ AgentController::class,'delete'])->name( 'agent_delete' );
...
Route::get(	'api/client/{id}', [ClientController::class,"list_clients" ])->name( "api_list_client" );
...
Route::post('api/agent/new', [ AgentController::class, 'create_agent'	])->name( 'api_create_agent' );
Route::post('api/agent/edit/{id}', [ AgentController::class,	'update_agent'])->name( 'api_update_agent' );
Route::get('api/agent',	[ AgentController::class,'list_agents'	])->name( 'api_list_agents' );
Route::delete('api/agent/delete/{id}',	[ AgentController::class,'delete_agent'	])->name( 'api_delete_agent' );
Route::get('api/agent/view/{id}',[ AgentController::class,"agent_view" ] )->name( "api_agent_view" );

Route::post('api/agent_transaction/new', [AgentTransactionController::class, 'create_agent_transaction'])->name('api_create_agent_transaction');
Route::post('api/agent_transaction/edit/{id}', [AgentTransactionController::class, 'agent_transaction_edit'])->name('api_update_agent_transaction');
...
Route::get('virtual-reality', function () {	return view('pages.virtual-reality');
...
Route::group([], function (){
	...
	Route::get('edit-general-sale/{saleId}',[EditGeneralSale::class,'editGeneralSale']	)->name( 'edit-general-sale' );
