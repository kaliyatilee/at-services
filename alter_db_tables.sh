...
mariadb -udeveloper -pdeveloppass 'muzanya_atservices' -e "ALTER TABLE insurance_transaction ADD COLUMN IF NOT EXISTS received_date DATETIME DEFAULT CURRENT_TIMESTAMP;"
